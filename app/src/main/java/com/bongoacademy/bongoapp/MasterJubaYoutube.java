...
public class MasterJubaYoutube extends WebView {
	...
	public MasterJubaYoutube(Context context) {
		super(context);
	}

	public MasterJubaYoutube(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public MasterJubaYoutube(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//		getSettings().setRenderPriority(WebSettings.RenderPriority.HIGH);
	...
	public void fullScreen() {
		...
		loadUrl("javascript:playFullscreen()");
	}
